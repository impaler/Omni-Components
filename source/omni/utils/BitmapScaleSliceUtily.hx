...
*
* slice array is as follows;
* vertical left, vertical right, horizontal top, horizontal bottom
* 
**/
class BitmapScaleSliceUtily
{
    public static inline function slice9(target:Sprite, targetWidth:Float, targetHeight:Float, bmp:BitmapData, slice:Array<Int>, smooth:Bool = false, debuglines:Bool = false):Sprite
    {
        if (slice.length < 4)
        {
        ...
        if (debuglines)
        {
            UtilPosition.drawXRegLine(target, slice[0], ColorUtils.BLUE);
            UtilPosition.drawXRegLine(target, slice[1], ColorUtils.GREEN);
            UtilPosition.drawYRegLine(target, slice[2], ColorUtils.ORANGE);
            UtilPosition.drawYRegLine(target, slice[3], ColorUtils.DARK_GRAY);
        }
    ...
    public static inline function slice3(w:Sprite, targetWidth:Float, targetHeight:Float, bmp:BitmapData, slice:Array<Int>, smooth:Bool = false):Sprite
    {
        w.graphics.clear();
