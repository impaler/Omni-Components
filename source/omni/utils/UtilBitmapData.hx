...
class UtilBitmapData
{
	...
	public static function fitIntoRect( displayObject:DisplayObject, rectangle:Rectangle, fillRect:Bool = true,
	                                    align:String = "MIDDLE", applyTransform:Bool = true ):Matrix
	{
	...
	public static inline function fitIntoRectBitmapData( data:BitmapData, width:Int, height:Int, 
	                                                     align:String = "MIDDLE",
	                                              transparent:Bool = false, fill:Bool = true, bgColor:Int = 0x0,
	...
	public static inline function arrangeVBox( array:Array<DisplayObject>, padding:Int = 10, 
