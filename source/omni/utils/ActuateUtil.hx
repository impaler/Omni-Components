...
// case 'Linear.easeNone': actuator = Actuate.tween(target, duration, properties, overwrite, customActuator).ease(Linear.easeNone);
	...
	public static function tweenPosition( target:Dynamic, duration:Float, xpos:Float, ypos:Float,
	                                      easing:String,
	                                      overwrite:Bool = true,
	...
	public static function tweenAlpha( target:Dynamic, duration:Float, alpha:Float,
	                                   easing:String,
	                                   overwrite:Bool = true,
	                                   customActuator:Class<GenericActuator> = null ):IGenericActuator
	{
	...
	public static function tween( target:Dynamic, duration:Float, properties:Dynamic, easing:String = 'Linear.easeNone',
