...
class UtilPosition
{
	...
	public static inline function setRegistrationPoint( parent:Sprite, regx:Float, regy:Float, color:Float = 0xffffff,
	                                                    line:Float = .2
	):Void
	{
	...
	public static inline function drawYRegLine( parent:Sprite, regy:Float, color:Int = 0xffffff, line:Float = .2
	):Void
	{
		var markReg:Sprite = new Sprite();
		markReg.graphics.clear( );
	...
	public static inline function drawXRegLine( parent:Sprite, regx:Float, color:Int = 0xffffff, line:Float = .2
	):Void
	{
		var markReg:Sprite = new Sprite();
		markReg.graphics.clear( );
